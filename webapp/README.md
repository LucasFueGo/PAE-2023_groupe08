...
- La page doit faire appel à la fonction `` du `Router` pour rediriger vers une autre page. Dans ce boilerplate, un example est fourni pour la `LoginPage` qui redirige vers la `HomePage` lors d'un clic sur un bouton.
